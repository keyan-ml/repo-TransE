...
void prepare()
{
    FILE* f1 = fopen("F:\新建文件夹\My Files\科研训练\KB2E-master\data\WN18\entity2id.txt","r");
	FILE* f2 = fopen("F:\新建文件夹\My Files\科研训练\KB2E-master\data\WN18\relation2id.txt","r");
	int x;
    ...
    FILE* f_kb = fopen("F:\新建文件夹\My Files\科研训练\KB2E-master\data\WN18\test.txt","r");
    ...
    fclose(f_kb);
    FILE* f_kb1 = fopen("F:\新建文件夹\My Files\科研训练\KB2E-master\data\WN18\train.txt","r");
    ...
    fclose(f_kb1);
    FILE* f_kb2 = fopen("F:\新建文件夹\My Files\科研训练\KB2E-master\data\WN18\valid.txt","r");
